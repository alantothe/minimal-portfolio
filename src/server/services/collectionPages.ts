...
export function renderProjectCollection(
          ...
          <a href="/projects/${encodeURIComponent(project.slug)}" class="project-link" data-project-id="${escapeHtml(project.slug)}" aria-label="Read ${escapeHtml(project.title)} case study">
            ...
            <span class="project-card__arrow" aria-hidden="true">
              <svg viewBox="0 0 56 56" fill="none">
                <circle class="project-arrow-ring-track" cx="28" cy="28" r="25" stroke-width="1.5"></circle>
                <circle class="project-arrow-ring-progress" cx="28" cy="28" r="25" pathLength="100" stroke-width="1.5"></circle>
                <path d="M20 28H36M30 22L36 28L30 34" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </span>
          </a>
        </article>
